  ...
  <header class="h-[70px] md:h-[80px] w-full bg-white z-[10] border-b border-gray-300 fixed">
        ...
        <ul class="flex h-full">
          ...
          >
            ...
            <div
              ...
              class="absolute left-1/2 transform -translate-x-1/2 mt-0 w-48 bg-white shadow-lg rounded-b-md py-1 z-10 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 ease-out"
            >
              <NuxtLink
                ...
                active-class="bg-blue-50 font-medium"
              >
                {{ child.label }}
              </NuxtLink>
            </div>
    ...
    >
      <div
        ...
        class="md:hidden absolute top-full left-0 right-0 bg-white shadow-lg z-[9999] overflow-hidden max-h-[calc(100vh-70px)] overflow-y-auto"
        ...
        <ul class="py-2">
          ...
          >
            <div
              ...
              class="flex justify-between items-center px-4 py-3 hover:bg-gray-50 cursor-pointer transition-colors"
            >
            ...
            <NuxtLink
              ...
              class="flex justify-between items-center px-4 py-3 hover:bg-gray-50 transition-colors text-sm font-medium"
            ...
            >
              <ul
                v-if="item.children.length > 0 && activeMobileSubmenu === index"
              ...
              >
                ...
                >
                  <NuxtLink
                    :to="child.url"
                    @click="isMobileMenuOpen = false"
                    class="block px-4 py-3 hover:bg-gray-100 transition-colors text-sm"
